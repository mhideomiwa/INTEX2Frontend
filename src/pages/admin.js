          ...
          <div className="row gutter-1 gutter-md-2">
            <div className="col-lg-4">
              <aside className="bg-white p-2 p-md-3">
                <h3 className="fs-20 text-uppercase text-muted mb-2">
                  Welcome, John Doe!
                </h3>
                <div
                  className="nav nav-menu flex-column lavalamp"
                  id="sidebar-1"
                  role="tablist"
                >
                  <a
                    className={`nav-link ${
                      activeTab === "sidebar-1-1" ? "active" : ""
                    }`}
                    data-toggle="tab"
                    href="#sidebar-1-1"
                    role="tab"
                    ...
                    aria-selected={
                      activeTab === "sidebar-1-1" ? "true" : "false"
                    }
                  >
                    <i className="fs-24 icon-sidebar"></i> Transaction History{" "}
                  </a>
                  <a
                    className={`nav-link ${
                      activeTab === "sidebar-1-2" ? "active" : ""
                    }`}
                    data-toggle="tab"
                    href="#sidebar-1-2"
                    role="tab"
                    ...
                    aria-selected={
                      activeTab === "sidebar-1-2" ? "true" : "false"
                    }
                  >
                  ...
                  <div
                    className="lavalamp-object ease"
                    style={lavalampStyle}
                  ></div>{" "}
                  {/* lavalamp effect */}
                </div>
                ...
                <div className="tab-content" id="myTabContent">
                  <div
                    className={`tab-pane fade ${
                      activeTab === "sidebar-1-1" ? "show active" : ""
                    }`}
                    id="sidebar-1-1"
                    role="tabpanel"
                  ...
                  <div
                    className={`tab-pane fade ${
                      activeTab === "sidebar-1-2" ? "show active" : ""
                    }`}
                    id="sidebar-1-2"
                    role="tabpanel"
                  ...
                  <div
                    className={`tab-pane fade ${
                      activeTab === "sidebar-1-4" ? "show active" : ""
                    }`}
                    id="sidebar-1-4"
                    role="tabpanel"
                    aria-labelledby="sidebar-1-4"
                  >
                    <ViewUsers products={products} />
                  </div>
                </div>
              </div>
            </div>
